...
I'm currently pursuing my **Bachelor of Technology (B.Tech)** with a strong interest in:
...
<ul>
  <li><strong>Languages:</strong> Python, SQL, Java, C</li>
  <li><strong>Frameworks & Libraries:</strong> TensorFlow, Keras, Streamlit, Scikit-learn</li>
  <li><strong>Tools & Platforms:</strong> Git, VS Code, OpenCV, NumPy, Pandas, Linux</li>
</ul>
...
<p>
  Active contributor with hands-on experience in Machine Learning, Deep Learning,
...
<p>
  I actively work on engineering and research-oriented projects focused on
  <strong>Machine Learning</strong>, <strong>Deep Learning</strong>, and
  <strong>Full Stack Web Development</strong>.
  I am committed to continuous learning and contributing to impactful,
...
<ul>
  <li><strong>Email:</strong> mummadicharan27@gmail.com</li>
  <li>
    <strong>LinkedIn:</strong>
    <a href="https://www.linkedin.com/in/ramcharan-mummadi-5973a72a3" target="_blank">
      linkedin.com/in/ramcharan-mummadi
    </a>
  </li>
  <li>
    <strong>Credly:</strong>
    <a href="https://www.credly.com/users/ramcharan-mummadi" target="_blank">
      credly.com/users/ramcharan-mummadi
    </a>
  </li>
</ul>
